...
import infovis.visualization.render.VisualStrokingLabel;
...
/**
 * Default visualization for the axis of a visualization when it
 * manages a ruler table.
 * 
 * @author Jean-Daniel Fekete
 * @version $Revision: 1.20 $
 */
public class DefaultAxisVisualization extends StrokingVisualization 
    ...
    /**
     * Sets the preferred size of the orthogonal direction.
     * @param preferedsize the preferred size
     */
    ...
    /**
     * Sets the TickRatio.
     * @param tickRatio the tick ratio
     */
    ...
    public void validateShapes(Rectangle2D bounds) {
        Component panel = visualization.getParent();
        visualization.validateShapes(
