...
public interface ItemRenderer {
    ...
    /**
     * Inserts an item renderer at the specified index
     * @param index the index
     * @param r the renderer to insert
     * @return this
     */
    ItemRenderer insertRenderer(int index, ItemRenderer r);
    /**
     * Adds an item renderer.
     * @param r the item renderer
     * @return this
     */
    ItemRenderer addRenderer(ItemRenderer r);
    /**
     * Removes the item renderer at the specified index
     * @param index the index
     * @return this
     */
    ItemRenderer removeRenderer(int index);
    /**
     * Replaces the item renderer at the specified index.
     * @param index the index
     * @param r the item renderer
     * @return this
     */
    ...
    /**
     * @return the visualization associated with this item renderer
     */
    Visualization getVisualization();

    /**
     * Returns an optimized version of this item renderer.
     * 
     * <p>This feature is experimental and could be 
     * removed.
     * @return an optimized version of this item renderer
     * or this
     */
    ItemRenderer compile();
    
    /**
     * Calls before any painting takes place to
     * allow the item renderer to allocate any
     * required ressource.
     * @param graphics the graphics
     */
    void install(Graphics2D graphics);
    /**
     * Install the graphic state or paint
     * the specified shape on the specified
     * graphics.
     * @param graphics the graphics
     * @param row the row of the shape
    ...
    void paint(
            ...
            Shape shape);
    /**
     * Releases the ressources allocated on the
     * specified graphics.
     * @param graphics the graphics
     */
    ...
    /**
     * Return true if the specified item intersects
     * the hitBox after being painted by this item
     * renderer.
     * @param hitBox the hit box
     * @param row the row
     * @param shape the shape
     * @return true if the specified item intersects
     * the hitbox when painted
     */
    boolean pick(
            Rectangle2D hitBox,
            int row,
    ...
    /**
     * @return true if this item renderer is a prototype
     * meant to be cloned instead of an instance associated
     * with a visualization
     */
    boolean isPrototype();
    
    /**
     * Deeply clones this item rendere considered as a
     * prototype and associates it with the specified
     * visualization.
     * @param vis the visualization
     * @return the instantiated item renderer
     */
