...
public class LinkShaperFactory extends BasicFactory {
    ...
    static private final Logger LOG   = Logger.getLogger(LinkShaperFactory.class);
    ...
    public void add(Creator creator) {
        putEntry(creator.getName(), creator);
    }
...
//            list.add(c);
//        }
//        Creator[] entry = new Creator[list.size()];
//        list.toArray(entry);
//        return entry;
//    }
//
//    /**
//     * Returns an iterator over the LinkShaper entry compatible with the
//     * specified LinkVisualization.
//     * 
//     * @param link
//     *            the LinkVisualization
//     * @return an iterator over the visualization entry compatible with the
//     *         specified table.
//     */
...
//            this.link = link;
//            entriesIterator = entry.entrySet().iterator();
//            skipIncompatible();
//        }
//
        ...
        public LinkShaper create() {
            if (linkShaperClass == null) {
                try {
                    ...
                    LOG.error("Cannot find LinkShaper class "+linkShaperClassName, e);
                    return null;
                }
            }
            Constructor cons;
            ...
            try {
                ...
                LOG.error("Cannot find empty constructor for LinkShaper class "
            ...
            if (cons != null) {
                try {
                    ...
                    LOG.error("Cannot instantiate LinkShaper class "
                            +linkShaperClassName, e);
                }
            }
            return null;
