...
public class VisualShape extends AbstractVisualColumn {
    ...
    /**
     * Returns the VisualShape associated with a specified visualization.
     * @param vis the visualization
     * @return the VisualShape associated with a specified visualization
