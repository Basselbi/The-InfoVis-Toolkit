...
public class VisualizationFactory extends BasicFactory {
    ...
    private static Logger LOG = Logger.getLogger(VisualizationFactory.class);

    public VisualizationFactory() {
        super("visualizationfactory");
    }
    ...
    public void add(String name, String visualization, String data) {
        ...
        try {
            ...
            LOG.error("Coulnd't find visualization class for "+data, e);
        }
    }
    ...
    /**
     * Returns an iterator over the visualization entry compatible with the
     * specified table.
     * 
     * @param table
     *            the table
    ...
    class VisualizationIterator implements Iterator {
        ...
        void skipIncompatible() {
            while (entriesIterator.hasNext()) {
                String name = (String) entriesIterator.next();
                current = (Creator)getEntry(name);
