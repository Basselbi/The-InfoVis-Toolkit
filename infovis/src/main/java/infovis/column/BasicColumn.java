...
//    	if( name == null )
//    		name = "";	// DON'T make callers throw NullPointerException because
    	// some graph reader somewhere or some graph format somewhere doesn't happen
    	// to include a name for a column.
        this.name = name;
    }
...
//        modified(MODIFIED_ALL);
     ...
     * 
     * @param v the value
     * @return true if the value has been added, false if null has been added 
     */
