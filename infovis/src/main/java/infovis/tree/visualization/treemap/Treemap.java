 ...
 */
public abstract class Treemap extends AbstractLayout {
...
//            firePropertyChange(PROPERTY_VISUALIZATION, null, vis);
        }
        else if (vis == null) {
//            Visualization old = visualization;
            ...
            sizeColumn = null;
            shapeColumn = null;
//            firePropertyChange(PROPERTY_VISUALIZATION, old, null);
        }
        else {
