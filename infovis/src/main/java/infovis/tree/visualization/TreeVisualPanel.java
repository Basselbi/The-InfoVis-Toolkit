...
public class TreeVisualPanel extends DefaultVisualPanel {
    ...
    protected void createAll() {
        ...
        addFlexibleTreeStructureControlPanel();
    }
//    
...
//    }
    ...
    protected void addFlexibleTreeStructureControlPanel(){
    	add(new FlexibleTreeStructureControlPanel(getTreeVisualization(), filter));
    }
