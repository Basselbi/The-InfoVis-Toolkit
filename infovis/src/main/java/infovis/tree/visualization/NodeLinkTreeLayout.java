 ...
 */
public abstract class NodeLinkTreeLayout extends AbstractLayout
    implements  Orientable {
    protected static final Logger                 LOG            = Logger.getLogger(NodeLinkTreeLayout.class);
