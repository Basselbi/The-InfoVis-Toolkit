...
import infovis.tree.property.DegreeColumn;
import infovis.tree.property.DepthColumn;
...
import infovis.utils.ZeroValueGenerator;
...
//    private NumberColumn           denseColumn;
    ...
    private AbstractDoubleColumn   weightColumn;
    ...
    public RowIterator childrenIterator(int node) {
        if (permutation != null) {
            ...
            if (children == null)
                ...
                return new IntArrayIterator(0, children);
        }
        else {
