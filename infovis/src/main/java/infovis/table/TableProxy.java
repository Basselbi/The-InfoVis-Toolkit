...
public class TableProxy extends ColumnProxy
    ...
    private static final long serialVersionUID = -6208284448085032027L;
    protected Table table;
    class MutableTableModelEvent extends TableModelEvent {
        private static final long serialVersionUID = -2780019046069053228L;

        MutableTableModelEvent() { super(TableProxy.this); }
        
        void setValues(int firstRow, int lastRow, int column, int type) {
    ...
    protected volatile MutableTableModelEvent TMP_EVENT = new MutableTableModelEvent();
    ...
    public void tableChanged(TableModelEvent e) {
        ...
        if (e.getSource() == table) {
            ...
            if (! hasEventListener() 
                    ||
                    getEventListenerList().getListenerCount(TableModelListener.class) == 0) {
                return;
            }
            TMP_EVENT.setValues(
                    e.getFirstRow(),
