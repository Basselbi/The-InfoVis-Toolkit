...
public abstract class AbstractTableReader extends AbstractReader {
    ...
    /**
     * Constructor for AbstractTableReader.
     * 
     * @param name
     *            the resource name.
     * @param table
     *            the table.
     *            
     * @exception IOException when a read error occurs
     * @exception FileNotFoundException when the file cannot be found
     */
    public AbstractTableReader(String name, Table table) 
     ...
     *            the quote character,
     * 
     * @return the character after the ending quote
     * 
     * @throws IOException
     *             pass exception from BufferedReader.
     */
    public int readQuoted(char quote) throws IOException {
        buffer.setLength(0);
        int c;
