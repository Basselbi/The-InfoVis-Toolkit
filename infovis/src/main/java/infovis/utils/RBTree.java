...
//    public int HISTORY_REMOVE = 2;
    ...
    public RBTree(RBTree other) {
        if (other != null) {
            this.root = new RBNode(other.root, NIL);
...
//        history.add(value);
     ...
     * @version $Revision: 1.11 $
     */
    private class RBNodeIterator implements Iterator {
    ...
    class KeyIterator extends RBNodeIterator implements RowIterator {
        /**
         * Constructor.
         */
        public KeyIterator() {
        ...
        /**
         * Constructor with a specified node.
         * @param node the node
         */
     ...
     */
    protected RBNodeIterator nodeIterator() {
