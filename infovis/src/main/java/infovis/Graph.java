...
public interface Graph extends Metadata {
    ...
    /**
     * Returns a Vertex object from a vertex index.
   ...
   void removeVertex(Vertex vertex);
    ...
    /**
     * Returns an Edge object from an edge index.
     ...
     * @return the second vertex of the edge.
     */
    Vertex getSecondVertex(Edge edge);
     ...
     * @return the outgoing edge of a specified vertex at a specified index or NIL.
     */
    Edge getOutEdgeAt(Vertex vertex, int index);
     ...
     * @return the incoming edge of a specified vertex at a specified index or NIL.
     */
    Edge getInEdgeAt(Vertex vertex, int index);
    ...
    /**
     * Returns an iterator over the outgoing edges of a specified vertex
     * using a specified iterator instead of allocating a new one.
     *
     * @param vertex the vertex.
     ...
     * @return the iterator over the outgoing edges of the vertex.
     */
    RowIterator outEdgeIterator(int vertex, RowIterator it);
     ...
     * @return the iterator over the outgoing edges of the vertex.
     */
    RowIterator outEdgeIterator(Vertex vertex);
    ...
    /**
     * Returns an iterator over the incoming edges of a specified vertex
     * using a specified iterator instead of allocating a new one.
     *
     * @param vertex the vertex.
     * @param it the iterator
     *
     * @return the iterator over the incoming edges of the vertex.
     */
    RowIterator inEdgeIterator(int vertex, RowIterator it);
     ...
     * @return an iterator over the incoming edges of the specified vertex
     */
    RowIterator inEdgeIterator(Vertex vertex);
    ...
    /**
     * Returns an iterator over all the edges (incoming and outgoing)
     * of a specified vertex reusing the specified iterator. 
     *
     * @param vertex the vertex.
     * @param it the row iterator to reuse
     *
     * @return the iterator over all the edges of the vertex.
     */
    RowIterator edgeIterator(int vertex, RowIterator it);
     ...
     * @return the iterator over all the edges of the vertex.
     */
    RowIterator edgeIterator(Vertex vertex);
    ...
    /**
     * @return an allocated RowIterator suited to edge iterators
     */
    RowIterator newEdgeIterator();
}
