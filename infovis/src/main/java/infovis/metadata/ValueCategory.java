 ...
 */
public abstract class ValueCategory extends AbstractMetadata 
    ...
    public static String getValueCategoryString(Column c) {
        return (String) getValue(c, VALUE_CATEGORY_TYPE);
    }
    ...
    public static void setValueCategory(Column c, int cat) {
        setValue(c, VALUE_CATEGORY_TYPE, CATEGORY_NAME[cat]);
    }
