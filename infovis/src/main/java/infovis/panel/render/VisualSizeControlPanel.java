...
/**
 * <b>VisualSizeControlPanel</b> is a control panel for editing a
 * <code>VisualSize</code>.
 * 
...
public class VisualSizeControlPanel extends AbstractVisualColumnPanel {
    ...
    /**
     * Creates a VisualSizeControlPanel. 
     * @param vc the Size Visual Column to edit
     */
    public VisualSizeControlPanel(AbstractVisualColumn vc) {
        ...
        defaultSizeSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                if (! defaultSizeSlider.getModel().getValueIsAdjusting()) {
