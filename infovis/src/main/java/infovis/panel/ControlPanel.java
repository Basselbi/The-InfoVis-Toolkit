...
public class ControlPanel extends JTabbedPane {
    ...
    /**
     * Constructor for ControlPanel that filters all internal columns.
     ...
     * 
     * <p>The filter specifies the column that should not be visible. Usually,
     * only the internal columns are filtered.
     * 
     * @param visualization the visualization
     * @param filter the column filer
     */
    public ControlPanel(Visualization visualization, ColumnFilter filter) {
        ...
        JComponent visual = createVisualPanel();
        visual.add(Box.createVerticalGlue());
        tabs.addTab(
                "Visual",
                null,
                new JScrollPane(visual),
                "Settings of visual attributes for this visualization");
        layout = new LayoutPanel(getVisualization());
        tabs.addTab(
                "Layout",
                null,
                new JScrollPane(layout),
                "Settings of layout attributes for this visualization");
        
        createOtherTabs();
    }

    /**
     * Frees all the resources of the visualization.
     */
    public void dispose() {
    ...
    /**
     * Sets the visualization panel.
     * 
     * @param visualizationPanel the panel
     */
