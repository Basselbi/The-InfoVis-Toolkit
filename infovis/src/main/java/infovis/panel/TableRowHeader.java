...
/**
 * Row headers for the DetailTable: shows the name of the attributes visualized
 * in the row of a scrollable pane so that it is always visible when scrolling
 * to see the details of the selection.
 * 
...
public class TableRowHeader extends JList {
    ...
    /**
     * Returns true if the row header is visible.
     * 
     * @param table
     *            the table
    ...
    /**
     * Removes the row header associated with the specified table.
     * 
     * @param table
     *            the table
     */
    ...
    static class TableRowHeaderModel extends AbstractListModel {
        private JTable table;
