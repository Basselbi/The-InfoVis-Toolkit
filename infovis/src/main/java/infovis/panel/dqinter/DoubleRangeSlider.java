...
public class DoubleRangeSlider extends JComponent
     ...
     */
    public HistogramVisualization getHistogram() {
        return histogram;
    }
     ...
     */
    public void setHistogram(HistogramVisualization histogram) {
        if (this.histogram == histogram) return;
        this.histogram = histogram;
        setHistogramVisible(inside);
        repaint();
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (histogram == null) {
            ...
            histogram.paint((Graphics2D)g, rect);
        }
...
//        }
    ...
    protected void setHistogramVisible(boolean set) {
        if (histogram == null) return;
        DefaultVisualLabel vl = (DefaultVisualLabel)VisualLabel.get(histogram);
        if (vl != null) {
            vl.setShowingLabel(set);
        }
    }
