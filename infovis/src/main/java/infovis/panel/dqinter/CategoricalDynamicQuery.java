...
public class CategoricalDynamicQuery extends AbstractDynamicQuery {
    protected NumberColumn     catColumn;
    ...
    public void update() {
        ...
        int min = catColumn.getIntAt(catColumn.getMinIndex());
        int max = catColumn.getIntAt(catColumn.getMaxIndex());
        int size = max - min + 2;
