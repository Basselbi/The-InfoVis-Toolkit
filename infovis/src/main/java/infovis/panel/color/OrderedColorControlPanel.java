...
//                    }
                    update();
                    VisualColor.get(getVisualization()).invalidate();
...
//                    }
        ...
        colorSchemes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (! oc.isSameRamp(scheme.getRamp())) {
...
//                getVisualization().repaint();
    ...
    /**
     * Returns the ordered color.
     * 
     * @return the ordered color
     */
     ...
     * @return the color scheme array
     */
    public static ColorScheme[] getSchemes() {
        return ColorScheme.findColorSchemes();
    }

    /**
     * Returns the index of the named color or -1.
     * @param name the name
     * @return the index of the named color or -1
     */
    public static int getColorSchemeOffset(String name) {
        ColorScheme[] pschemes = getSchemes();
    ...
    /**
     * Sets the specified color scheme in the visualization.
     * @param index index of the scheme
    ...
    /**
     * Sets the specified color scheme by name in the visualization.
     * @param name the name
     * @param vis the visualization
     * @return true if the scheme has been set
     */
    ...
    /**
     * Finds a scheme given its start and end color, creating it
