...
public class SplashPanel extends JEditorPane {
    ...
    public SplashPanel() {
        try {
            setPage(SplashPanel.class.getClassLoader().getResource("resources/splash.html"));
        }
        catch (IOException e) {
            ...
            setText(
                ...
                "<text>"+
                "<p>Welcome to the <b>InfoVis Toolkit</b> version @VERSION@<br>\n"+
                "Copyright (C) 2003-2007 Jean-Daniel Fekete and INRIA, France.</p>\n"+
