...
/**
 * <b>GraphLayoutFactory</b> is a factory of graph layout.
 * 
...
public class GraphLayoutFactory extends BasicFactory {
    ...
    private static Logger LOG = Logger.getLogger(GraphLayoutFactory.class);

    /**
     * @return the standard instance of this factory
     */
    ...
    /**
     * Sets the standard instance of this factory. 
    ...
    /**
     * Creates a layout from a specified name and visualization.
     * @param name the name
     * @param visualization the visualization
     * @return a layout or null
     */
    ...
    public static class DefaultCreator extends AbstractCreator {
        ...
        public NodeLinkGraphLayout create(NodeLinkGraphVisualization vis) {
            try {
                ...
                LOG.error("Cannot instantiate NodeLinkGraphLayout"+clas, e);                
            }
            return null;
        }
    }
