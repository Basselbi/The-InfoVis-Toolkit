...
public class DOTGraphReader extends AbstractGraphReader {
    ...
    private static String defaultAttributePrefix = "#dot_";

    protected DOTLexer  lexer;
    protected DOTParser parser;
    protected String    attributePrefix = defaultAttributePrefix;
    ...
    /**
     * @return the defaultAttributePrefix
     */
    public static String getDefaultAttributePrefix() {
        return defaultAttributePrefix;
    }
    
    /**
     * @param defaultAttributePrefix the defaultAttributePrefix to set
     */
    public static void setDefaultAttributePrefix(String defaultAttributePrefix) {
        DOTGraphReader.defaultAttributePrefix = defaultAttributePrefix;
    }
