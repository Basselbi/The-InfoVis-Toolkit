...
public class GMLGraphReader extends AbstractGraphReader {
    ...
    /**
     * Creates a GMLGraphReader with the specified InputStream, name and graph.
    ...
    protected ArrayList parseList() throws IOException {
    ...
    /**
     * Returns the node with the specified ID or NIL
