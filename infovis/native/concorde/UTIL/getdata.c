        ...
        CCdatagroup *dat, int binary_out)
{
    ...
    if (binary_out) {
      ...
      if (strcmp (outedgename, "stdout") == 0 
	  || strcmp (outedgename, "-") == 0) {
	fout = stdout;
      } else if (strcmp (outedgename, "stderr") == 0) {
	fout = stderr;
      } else {
        ...
        int binary_out)
{
    ...
    if (binary_out) {
        ...
        if (strcmp (outcyclename, "stdout") == 0 
	    || strcmp (outcyclename, "-") == 0) {
	    cycfout = stdout;
	} else if (strcmp (outcyclename, "stderr") == 0) {
	    cycfout = stderr;
	} else {
