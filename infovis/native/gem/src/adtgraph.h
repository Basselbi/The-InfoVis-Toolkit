...
#define	VMAX		500000     /* maximum number of vertices */
#define	EMAX		7000000	/* maximum number of edges */
...
#define	this_vertex(e)			NODE[-(e)]
#define	that_vertex(e)			NODE[e]

/* typedefs */

typedef int		vertex; /* vertices are enumerated from 1..VMAX */
typedef int		edge; /* edges are 1..EMAX or -1..-EMAX (reverse) */
...
extern vertex		*NODE; /* NODE[e], NODE[-e] are e's incident vertices */
...
void 	init_graph (void); /* allocates memory for link structures */
void 	exit_graph (void); /* deallocates memory */
void 	create_graph (void); /* initializes graph structures */
